...
export const updateService = createAction('[Service] Update Service',props<{service: ServiceModel}>());
export const updateServiceSuccess = createAction('[Service] Update Service Success',props<{service: ServiceModel}>());
export const updateServiceError = createAction('[Service] Update Service Error',props<{error: string}>());
